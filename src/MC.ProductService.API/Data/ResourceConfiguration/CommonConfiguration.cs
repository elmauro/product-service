...
namespace MC.ProductService.API.Data.ResourceConfiguration
{
    ...
    /// <summary>
    /// Provides PostgreSQL configuration for resource entities of type <typeparamref name="T"/>,
    /// where <typeparamref name="T"/> is a class implementing <see cref="IResource"/>.
    /// This class extends the generic <see cref="ResourceConfiguration{T}"/> to apply database
